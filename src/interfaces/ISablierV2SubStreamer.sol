...
interface ISablierV2SubStreamer {
    ...
    function createLinearSubStreamsWithDuration(uint256 streamId, ISablierV2LockupLinear lockupLinear, address[] calldata receivers, uint128[] calldata weightsPercent, uint40 cliffTime, uint40 totalDuration) external returns (uint256[] memory);
